...
const CardList: React.FC = (props) => {
    ...
    return (
        <div {...props} style={{ display: 'flex', overflow: 'hidden' }}>
            ...
            <PrevButton id="prev-button" ref={prevRef} role="button" style={{ visibility: prev ? 'visible' : 'hidden' }}>
                <img src={sliderArrow} style={{ transform: 'rotate(180deg)' }} alt="previous" />
            </PrevButton>
            <NextButton id="next-button" ref={nextRef} role="button" style={{ visibility: next ? 'visible' : 'hidden' }}>
